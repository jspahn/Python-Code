...
for i in range(397):
    ...
    # vertical
    if i < 339:
        v = int(grid[i]) * int(grid[i + 20]) * int(grid[i + 40]) * int(grid[i + 60])
        if v > max:
            max = v
            index = i
            type = "V"
    ...
    if i % 20 < 17 and i < 337:
        v = int(grid[i]) * int(grid[i + 21]) * int(grid[i + 42]) * int(grid[i + 63])
        if v > max:
            max = v
            index = i
            type = "DR"
...
print(str(int(index/20)) + "-" + str(int(index%20)) + " " + type)
print(max)
